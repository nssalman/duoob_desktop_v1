...
class _AuthWebViewWindowsState extends State<AuthWebViewWindows> {
  ...
  final String authUrl = 
      "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=4ea53c57-1ea0-4fe6-b8e8-317b05a6cb1e&response_type=code&redirect_uri=https://rpsmart.com/redirecturl_RakpAppmob.aspx&response_mode=query&scope=offline_access%20user.read%20mail.read&state=12345";
  
  final String redirectBase = "https://rpsmart.com/redirecturl_RakpAppmob.aspx";
          ...
          Positioned.fill(
            child: InAppWebView(
              ...
              onLoadStop: (controller, url) async {
                ...
                if (url != null && url.toString().startsWith(redirectBase)) {
